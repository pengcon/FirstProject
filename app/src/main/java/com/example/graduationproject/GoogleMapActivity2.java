        ...
        LocationListener
{
    ...
    private void setUpMap(){
        ...
        for(DTO entity : list) {
            ...
            options.position(new LatLng(entity.getmapy(), entity.getmapx()));
            options.title(entity.gettitle());
            options.icon(BitmapDescriptorFactory.fromResource(R.drawable.custom_marker_red));
    ...
    public void onLocationChanged(Location location) {
        ...
        Intent intent = new Intent(GoogleMapActivity2.this,Parser.class);
